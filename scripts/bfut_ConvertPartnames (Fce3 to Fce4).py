...
"""
    bfut_ConvertPartnames (Fce3 to Fce4).py - convert partnames from FCE3 to FCE4

USAGE
    python "bfut_ConvertPartnames (Fce3 to Fce4).py" /path/to/model.fce [/path/to/output.fce]
